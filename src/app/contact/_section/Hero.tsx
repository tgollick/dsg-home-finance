      ...
      <section className="relative w-full max-w-[1400px] h-full flex items-center justify-center px-6">
        ...
        <div className="w-full mx-auto relative pt-40 pb-[41rem] sm:pt-52 md:pt-64 lg:pt-72 xl:pb-80">
          ...
          <motion.div
            ...
            className="flex flex-col items-center md:items-start gap-8 md:gap-10 text-white text-center md:text-left max-w-[700px]"
          >
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-serif leading-tight w-full">
              Your Mortgage Questions,{" "}
              <span className="border-b-4 border-[#E5A1B7]">Answered</span>
            </h1>
            <div>
              <p className="text-sm sm:text-base font-sans font-bold text-[#F49FB7] mb-4">
                Have a question about rates, protection plans, or your
                application?
              </p>
              <p className="text-sm sm:text-base font-sans">
                Fill out the form below, and David’s team will get back to you
                within 24 hours. No pressure, just expert guidance tailored to
                your needs.
              </p>
            </div>
          </motion.div>
