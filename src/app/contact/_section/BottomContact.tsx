    ...
    <section className="w-full max-w-[1400px] h-full mx-auto py-20 px-6 xl:pt-20 pt-[575px]">
      ...
      <div className="w-full max-w-[700px]">
        <p className="text-sm sm:text-base font-sans mb-6">
          ...
          your goals and give you a clear roadmap. You&apos;ll need to share
          just two things:
        </p>
        ...
        <p className="text-sm sm:text-base font-sans mb-6">
          ...
          your journey. We understand that every client&apos;s needs are unique,
          and we are here to listen and guide you.
        </p>
        <p className="text-sm sm:text-base font-sans mb-6">
