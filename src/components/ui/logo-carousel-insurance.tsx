...
import * as BrandLogos from "../../../public/insurance";
...
export function LogoCarousel({ columns = 2 }: { columns?: number }) {
  ...
  const logos = useMemo<Logo[]>(
    () => [
      { id: 1, name: "Zurich", src: BrandLogos.Zurich.src },
      { id: 2, name: "Guardian", src: BrandLogos.Guardian.src },
      { id: 3, name: "Vitality", src: BrandLogos.Vitality.src },
      { id: 4, name: "LV", src: BrandLogos.LV.src },
      { id: 5, name: "LegalGeneral", src: BrandLogos.LegalGeneral.src },
      { id: 6, name: "Aviva", src: BrandLogos.Aviva.src },
      { id: 7, name: "AIG", src: BrandLogos.AIG.src },
    ],
    []
  );
